...
export default function UpdateManager() {
  ...
  useEffect(() => {
    ...
    const checkUpdate = async () => {
      try {
        ...
        const minAppVersion =
          rc.getValue('minAppVersion').asString()
        ...
        const forceVal =
          rc.getValue('forceUpdate').asString()
        ...
        console.log('Remote Min Version:', minAppVersion)
        console.log('Remote Min VersionCode:', minVersionCode)
  ...
  const startDownload = async () => {
    ...
    try {
      ...
      console.log('APK Download Path:', dest)
      ...
      console.log('FULL INSTALL ERROR =>', err)
